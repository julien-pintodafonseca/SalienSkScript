...
game.log("^GRN-- If you want to support a steam group and represent it in game:")	
game.log("^GRN-- Just join the group and set us as your clan on")	
game.log("^GRN-- ^YELhttps://steamcommunity.com/saliengame/play")	
game.log("^RED-- SalienSkScript starts!")	
